...
try {
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'send_reset') {
      ...
      $reset_link_label = tr('reset_password','Reset password');
      $html = '<html><body>'
            . '<p>Use the link below to reset your password. This link expires in 60 minutes.</p>'
            . '<p><a href="'.htmlspecialchars($reset_link, ENT_QUOTES, 'UTF-8').'">'.htmlspecialchars($reset_link_label, ENT_QUOTES, 'UTF-8').'</a></p>'
