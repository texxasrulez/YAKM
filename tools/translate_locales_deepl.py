...
"""
DeepL-powered translator for Kontact localization *.inc files.
...
SUPPORTED_TARGETS = {
    "AS","AR","BG","CS","DA","DE","EL","EN","EN-GB","EN-US","ES","ES-419","ET","FI","FR","HE","HU","ID",
    "IT","JA","KO","LT","LV","NB","NL","NO","PL","PT","PT-BR","PT-PT","RO","RU","SK","SL","SV","TH","TR","UK","VI",
    "ZH","ZH-HANS","ZH-HANT"
}

def normalize_target(code):
    t = code.upper()
    if t == "PT":
        t = "PT-BR"  # choose one; change to PT-PT if preferred
    if t == "NO":
        t = "NB"
    if t in ("ZH","ZH-CN"):
        t = "ZH-HANS"
...
DEEPL_CODE_MAP = {
    ...
    "es_AR":"AR","pt_BR":"PT-BR","pt_PT":"PT-PT",
    "nl_NL":"NL","sv_SE":"SV","da_DK":"DA","nb_NO":"NB","nn_NO":"NO",
    "fi_FI":"FI","pl_PL":"PL","cs_CZ":"CS","sk_SK":"SK","sl_SI":"SL",
    "ro_RO":"RO","hu_HU":"HU","bg_BG":"BG","el_GR":"EL","et_EE":"ET",
    "lv_LV":"LV","lt_LT":"LT","tr_TR":"TR","uk_UA":"UK","ru_RU":"RU",
    "ja_JP":"JA","ko_KR":"KO","zh_CN":"ZH-HANS","zh_TW":"ZH-HANT",

    "as":"AS","ar":"AR","ar_SA":"AR","he_IL":"HE","id_ID":"ID","vi_VN":"VI","th_TH":"TH",

    "en_GB":"EN-GB","en_US":"EN-US","en_AU":"EN-GB","en_CA":"EN-US",

    # Optional: LATAM Spanish if you maintain such a file
    "es_419":"ES-419",
}
