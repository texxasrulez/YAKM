...
<head>
  ...
  --bg:transparent;
  --hcolor:#000;
  --h-primary-color: #39ff14; /* Top color variable */
  --h-secondary-color: #5bff3d; /* Bottom color variable */
  ...
  --border:#39ff14;
  --lborder:#c7e3ef;
  --c-primary-color: #1b3347; /* Top color variable */
  --c-secondary-color: #0f202f; /* Bottom color variable */
  ...
  --roweven:#f0fff0;
  --fcolor:#000;
  --f-primary-color: #5bff3d; /* Top color variable */
  --f-secondary-color: #39ff14; /* Bottom color variable */
...
<tr class='header'><th align='center' colspan='2'><a href='".$site_url."'><img src='". $site_url.$site_logo."_dark.svg' align='left' height='25px'></a><font size='4'><strong>" . $form_title . " " . $form_name . "</strong></font></th></tr>
