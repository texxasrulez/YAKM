...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #083034; /* Top color variable */
  --h-secondary-color: #0e4f55; /* Bottom color variable */
  ...
  --roweven:#cdf7f1;
  --fcolor:#fff;
  --f-primary-color: #0e4f55; /* Top color variable */
  --f-secondary-color: #083034; /* Bottom color variable */
