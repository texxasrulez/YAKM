...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #590000; /* Top color variable */
  --h-secondary-color: #8b0000; /* Bottom color variable */
  ...
  --roweven:#ffecec;
  --fcolor:#fff;
  --f-primary-color: #8b0000; /* Top color variable */
  --f-secondary-color: #590000; /* Bottom color variable */
