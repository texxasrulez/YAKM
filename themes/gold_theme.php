...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #8f6808; /* Top color variable */
  --h-secondary-color: #b8860b; /* Bottom color variable */
  ...
  --roweven:#fffbea;
  --fcolor:#fff;
  --f-primary-color: #b8860b; /* Top color variable */
  --f-secondary-color: #8f6808; /* Bottom color variable */
