...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #352b4f; /* Top color variable */
  --h-secondary-color: #4d3d73; /* Bottom color variable */
  ...
  --roweven:#f5f0fb;
  --fcolor:#fff;
  --f-primary-color: #4d3d73; /* Top color variable */
  --f-secondary-color: #352b4f; /* Bottom color variable */
