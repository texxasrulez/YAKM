...
<head>
  ...
  --bg:transparent;
  --hcolor:#ccf2f2;
  --h-primary-color: #006060; /* Top color variable */
  --h-secondary-color: #008b8b; /* Bottom color variable */
  ...
  --roweven:#e0fbfb;
  --fcolor:#ccf2f2;
  --f-primary-color: #008b8b; /* Top color variable */
  --f-secondary-color: #006060; /* Bottom color variable */
