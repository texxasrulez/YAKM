...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #452d1c; /* Define a color variable */
  --h-secondary-color: #5c3a21; /* Define another color variable */
  ...
  --border:#452d1c;
  --lborder:#e5e5e5;
  --c-primary-color: #452d1c; /* Define a color variable */
  --c-secondary-color: #5c3a21; /* Define another color variable */
  ...
  --roweven:#f0eadc;
  --fcolor:#fff;
  --f-primary-color: #5c3a21; /* Define a color variable */
  --f-secondary-color: #452d1c; /* Define another color variable */
