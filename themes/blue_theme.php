...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #152f40; /* Top color variable */
  --h-secondary-color: #1d435c; /* Bottom color variable */
  ...
  --roweven:#d0e4f5;
  --fcolor:#9fb6c6;
  --f-primary-color: #1d435c; /* Top color variable */
  --f-secondary-color: #152f40; /* Bottom color variable */
