...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #bc4b00; /* Top color variable */
  --h-secondary-color: #d35400; /* Bottom color variable */
  ...
  --roweven:#fff0e0;
  --fcolor:#fff;
  --f-primary-color: #d35400; /* Top color variable */
  --f-secondary-color: #bc4b00; /* Bottom color variable */
