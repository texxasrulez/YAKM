...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #000; /* Define a color variable */
  --h-secondary-color: #1a1a1a; /* Define another color variable */
  ...
  --border:#000;
  --lborder:#52525b;
  --c-primary-color: #1a1a1a; /* Define a color variable */
  --c-secondary-color: #000; /* Define another color variable */
  ...
  --roweven:#c1b9b9;
  --fcolor:#fff;
  --f-primary-color: #000; /* Define a color variable */
  --f-secondary-color: #1a1a1a; /* Define another color variable */
