...
<head>
  ...
  --bg:transparent;
  --hcolor:#333;
  --h-primary-color: #dfdfdf; /* Top color variable */
  --h-secondary-color: #f9f9f9; /* Bottom color variable */
  ...
  --roweven:#f2f2f2;
  --fcolor:#333;
  --f-primary-color: #f9f9f9; /* Top color variable */
  --f-secondary-color: #dfdfdf; /* Bottom color variable */
...
<tr class='header'><td align='center' colspan='2'><a href='".$site_url."'><img src='". $site_url.$site_logo."_dark.svg' align='left' height='25px'></a><font size='4'><strong>$form_title $form_name</strong></font></td></tr>
