...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #2a1145; /* Top color variable */
  --h-secondary-color: #3f1a67; /* Bottom color variable */
  ...
  --roweven:#eeddf1;
  --fcolor:#fff;
  --f-primary-color: #3f1a67; /* Top color variable */
  --f-secondary-color: #2a1145; /* Bottom color variable */
