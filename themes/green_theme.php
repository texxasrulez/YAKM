...
<head>
  ...
  --bg:transparent;
  --hcolor:#f0fdf0;
  --h-primary-color: #1b3a1b; /* Top color variable */
  --h-secondary-color: #2c5f2d; /* Bottom color variable */
  ...
  --roweven:#f0fdf0;
  --fcolor:#f0fdf0;
  --f-primary-color: #2c5f2d; /* Top color variable */
  --f-secondary-color: #1b3a1b; /* Bottom color variable */
