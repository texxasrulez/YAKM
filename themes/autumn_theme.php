...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #742d1d; /* Define a color variable */
  --h-secondary-color: #6e1f06; /* Define another color variable */
  ...
  --border:#ad5c2a;
  --lborder:#ad5c2a;
  --c-primary-color: #1b3347; /* Define a color variable */
  --c-secondary-color: #0f202f; /* Define another color variable */
  ...
  --roweven:#f1d4c4;
  --fcolor:#fff;
  --f-primary-color: #6e1f06; /* Define a color variable */
  --f-secondary-color: #742d1d; /* Define another color variable */
