...
<body>
 <br />
  <div class='container'>
    <div class='header'><a href='".$site_url."'><img src='". $site_url.$site_logo."' align='left' height='25px'></a>New Contact Message Received</div>
    <div class='content'>
      <div class='row'>
      ...
      <div class='row'>
        ...
        <div class='value' style='white-space: pre-wrap;'>" . clean_string($message) . "</div>
      </div>
      <div class='row'>
