...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #8d0f5e; /* Top color variable */
  --h-secondary-color: #c71585; /* Bottom color variable */
  ...
  --roweven:#fde9f4;
  --fcolor:#fff;
  --f-primary-color: #c71585; /* Top color variable */
  --f-secondary-color: #8d0f5e; /* Bottom color variable */
