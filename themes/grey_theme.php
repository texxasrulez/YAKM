...
<head>
  ...
  --bg:transparent;
  --hcolor:#fff;
  --h-primary-color: #363636; /* Top color variable */
  --h-secondary-color: #434343; /* Bottom color variable */
  ...
  --roweven:#d4d4d4;
  --fcolor:#fff;
  --f-primary-color: #434343; /* Top color variable */
  --f-secondary-color: #363636; /* Bottom color variable */
